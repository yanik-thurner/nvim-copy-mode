...
vim.api.nvim_create_autocmd("TextYankPost", {
	...
	callback = function()
		...
		local tmux_job = vim.fn.jobstart({ "tmux", "load-buffer", "-" })
		vim.fn.chansend(tmux_job, text)
		vim.fn.chanclose(tmux_job, "stdin")
		local clip_job = vim.fn.jobstart({ clipboard })
		vim.fn.chansend(clip_job, text)
